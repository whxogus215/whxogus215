...
- `DB 확장 설계`를 공부하고 있습니다. [학습 프로젝트](https://github.com/whxogus215/database-practice/tree/main/design)
...
| **역할** | 백엔드 API 개발 담당 |
| **주요 성과** | ∙ Zstd 압축 및 Chunked 스트리밍 도입으로 API 응답 최적화 (60s -> 200ms) <br>∙ Brotli 압축 모듈을 적용한 NginX를 활용해 웹 사이트 로딩 속도 및 네트워크 효율 개선<br>∙ API 시퀀스 다이어그램 제작으로 효율적인 배포작업에 기여|
