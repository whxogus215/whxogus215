...
| 항목 | 내용 |
| --- | --- |
| **기간** | [V1](https://github.com/whxogus215/gonghak98) : 2024.01 ~ 2025.02 (1년 1개월) <br> [V2](https://github.com/whxogus215/gonghak98-V2) : 2025.07 ~ ing|
| **팀** | BE 3명 |
...
| **역할** | 백엔드 API 개발 담당 |
| **주요 성과** | ∙ Custom Servlet Filter 기반의 Zstd 압축 및 응답 스트리밍 구현 <br>∙ Brotli 압축 모듈을 적용한 NginX를 활용해 웹 사이트 로딩 속도 및 네트워크 효율 개선<br>∙ API 시퀀스 다이어그램 제작으로 효율적인 배포작업에 기여|
